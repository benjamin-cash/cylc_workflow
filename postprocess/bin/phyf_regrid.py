...
# Get list of files to process
    flist = get_filelist(datadir,"phyf???.nc")

# Netcdf output from the model may have poorly defined dimensions that causes
# an xarray error.
    check_xrgrid(flist)
...
# Drop lat and lon from the list of variables to process
        vlist.remove("lon")
        vlist.remove("lat")
